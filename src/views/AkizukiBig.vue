<template>
  ...
  <div class="container mx-auto flex-row p-5 item-center">
    <p class="text-2xl font-medium title-font text-gray-900 mb-2">Code <button class="text-white bg-gray-500 border-0 ml-5 py-2 px-8 focus:outline-none hover:bg-gray-600 rounded text-xs align-top" v-clipboard="payload2string">Copy to Clipboard</button></p>
